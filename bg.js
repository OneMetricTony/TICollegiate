// HUD circuit-board background: faint cyan traces on deep navy charcoal,
// glowing solder pads at the junctions, and light pulses racing along the
// lines (cyan / gold). Gamer HUD world — no red.
  ...
  function buildTraces() {
    ...
    for (var t = 0; t < count; t++) {
      ...
      traces.push({
        ...
        hue: Math.random() < 0.34 ? "242,183,62" : "56,189,248" // gold vs cyan
      });
    }

    // a few soft cyan depth glows behind the board
    glows = [];
    for (var g = 0; g < 3; g++) {
